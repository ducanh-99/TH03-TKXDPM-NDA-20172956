...
@JsonSubTypes({ @Type(value = CompactDisc.class, name = "cd"), @Type(value = DigitalVideoDisc.class, name = "dvd"),
...
public class PhysicalMedia extends Media {
	...
	public PhysicalMedia(String id, String title, String category, float cost, String barcode, String description,
			int quantity, float weight, Dimension dimension) {
		super(id, title, category, cost);
	...
	public String toString() {
		return super.toString() + ", barcode: " + barcode + ", description: " + description + ", quantity: " + quantity
	...
	public boolean match(Media media) {
		...
		if (pMedia.description != null && !pMedia.description.equals("")
				&& !this.description.contains(pMedia.description)) {
			return false;
		}
